 ...
 */
class Sml_Loan_Application implements Helper_Interface_Config, Helper_Interface_Setup_TearDown {
	 ...
	 * @Internal Recommend creating the directory structure /install/Sml_Loan_Application/ for bundled fonts
	 *
	 * @since    1.0
	 */
	public function setUp() {
		$font_data = [
			'font_name'   => 'Helvetica Condensed Light',
			'regular'     => __DIR__ . '/../install/Sml_Loan_Application/helvetica-condensed-light/Helvetica-Condensed-Light.ttf',
			'italics'     => __DIR__ . '/../install/Sml_Loan_Application/helvetica-condensed-light/Helvetica-Condensed-LightObl.ttf',
			'bold'        => __DIR__ . '/../install/Sml_Loan_Application/helvetica-condensed-light/Helvetica-Condensed-Bold.ttf',
			'bolditalics' => __DIR__ . '/../install/Sml_Loan_Application/helvetica-condensed-light/Helvetica-Condensed-BoldObl.ttf',
		];
	...
	public function tearDown() {
		...
		$misc->rmdir( __DIR__ . '/../install/Sml_Loan_Application/' );
	}
