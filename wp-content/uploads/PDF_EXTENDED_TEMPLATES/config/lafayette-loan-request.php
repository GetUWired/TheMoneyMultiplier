 ...
 */
class Lafayette_Loan_Request_Form implements Helper_Interface_Config, Helper_Interface_Setup_TearDown {
	 ...
	 * @Internal Recommend creating the directory structure /install/Loan_Request_Form/ for bundled fonts
	 *
	 * @since    1.0
	 */
	public function setUp() {
		$font_data = [
			'font_name'   => 'AGaramond',
			'regular'     => __DIR__ . '/../install/Ohio_Loan_Request_Form/agaramond/AGaramond-Regular.ttf',
			'italics'     => __DIR__ . '/../install/Ohio_Loan_Request_Form/agaramond/AGaramond-Italic.ttf',
			'bold'        => __DIR__ . '/../install/Ohio_Loan_Request_Form/agaramond/AGaramond-Bold.ttf',
			'bolditalics' => __DIR__ . '/../install/Ohio_Loan_Request_Form/agaramond/AGaramond-BoldItalic.ttf',
		];
	...
	public function tearDown() {
		...
		$misc->rmdir( __DIR__ . '/../install/Lafayette_Loan_Request_Form/' );
	}
