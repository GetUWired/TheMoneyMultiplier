 ...
 */
class Ohio_Direct_Deposit_Form implements Helper_Interface_Config, Helper_Interface_Setup_TearDown {
	 ...
	 * @Internal Recommend creating the directory structure /install/Direct_Deposit_Form/ for bundled fonts
	 *
	 * @since    1.0
	 */
	public function setUp() {
		$font_data = [
			'font_name'   => 'Calibri',
			'regular'     => __DIR__ . '/../install/Ohio_Direct_Deposit_Form/calibri/calibri.ttf',
			'italics'     => __DIR__ . '/../install/Ohio_Direct_Deposit_Form/calibri/calibrii.ttf',
			'bold'        => __DIR__ . '/../install/Ohio_Direct_Deposit_Form/calibri/calibrib.ttf',
			'bolditalics' => __DIR__ . '/../install/Ohio_Direct_Deposit_Form/calibri/calibriz.ttf',
		];
	...
	public function tearDown() {
		...
		$misc->rmdir( __DIR__ . '/../install/Ohio_Direct_Deposit_Form/' );
	}
