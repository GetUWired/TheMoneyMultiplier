 ...
 */
class Penn_Mutual_Loan implements Helper_Interface_Config, Helper_Interface_Setup_TearDown {
	 ...
	 * @Internal Recommend creating the directory structure /install/Penn_Mutual_Loan/ for bundled fonts
	 *
	 * @since    1.0
	 */
	public function setUp() {
		$font_data = [
			'font_name'   => 'Candara',
			'regular'     => __DIR__ . '/../install/Penn_Mutual_Loan/candara/candara.ttf',
			'italics'     => __DIR__ . '/../install/Penn_Mutual_Loan/candara/candarai.ttf',
			'bold'        => __DIR__ . '/../install/Penn_Mutual_Loan/candara/candarab.ttf',
			'bolditalics' => __DIR__ . '/../install/Penn_Mutual_Loan/candara/candaraz.ttf',
		];
	...
	public function tearDown() {
		...
		$misc->rmdir( __DIR__ . '/../install/Penn_Mutual_Loan/' );
	}
