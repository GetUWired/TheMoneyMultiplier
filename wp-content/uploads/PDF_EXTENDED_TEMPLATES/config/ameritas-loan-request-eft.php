 ...
 */
class Ameritas_Loan_Request_Eft implements Helper_Interface_Config, Helper_Interface_Setup_TearDown {
	 ...
	 * @Internal Recommend creating the directory structure /install/Loan_Request_Eft/ for bundled fonts
	 *
	 * @since    1.0
	 */
	public function setUp() {
		$font_data = [
			'font_name'   => 'Helvetica Neue LT Std Condensed',
			'regular'     => __DIR__ . '/../install/Ameritas_Loan_Request_Eft/helvetica-neue-lt-std-condensed/HelveticaNeueLTStd-Cn.ttf',
			'italics'     => __DIR__ . '/../install/Ameritas_Loan_Request_Eft/helvetica-neue-lt-std-condensed/HelveticaNeueLTStd-CnO.ttf',
			'bold'        => __DIR__ . '/../install/Ameritas_Loan_Request_Eft/helvetica-neue-lt-std-condensed/HelveticaNeueLTStd-Bold-Cn.ttf',
			'bolditalics' => __DIR__ . '/../install/Ameritas_Loan_Request_Eft/helvetica-neue-lt-std-condensed/HelveticaNeueLTStd-Bold-CnO.ttf',
		];
	...
	public function tearDown() {
		...
		$misc->rmdir( __DIR__ . '/../install/Ameritas_Loan_Request_Eft/' );
	}
