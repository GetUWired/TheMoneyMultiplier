...
//$app was set in conn.php
	...
	$deleteRows = "DELETE FROM NewPolicyMonthlyReport";
	// prepare
...
//insert each line into the table 
		$sql = "INSERT INTO NewPolicyMonthlyReport (Id, InsuredFirstName, InsuredLastName, PolicyAmt, InforceDate, CommissionOwner1, CommissionOwner2, CommissionOwner3, CommissionOwner4, CommissionOwner5, CommissionOwner6, CommissionOwner7, CommissionOwner8, CommissionOwner9, CommissionOwner10) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
